...
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_smallFolder_singlePage` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_smallFolder_singlePage()` | 2 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_exactPageSize_singlePage` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_exactPageSize_singlePage()` | 2 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_overPageSize_twoPages` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_overPageSize_twoPages()` | 3 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_manyItems_multiplePages` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_manyItems_multiplePages()` | 4 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_emptyItems_emptyPages` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_emptyItems_emptyPages()` | 1 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageSplitting_preservesOrder` | `LaunchPadTests.FolderOverlayViewPagingTests/pageSplitting_preservesOrder()` | 1 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageCount_singlePage_noDots` | `LaunchPadTests.FolderOverlayViewPagingTests/pageCount_singlePage_noDots()` | 1 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
| `LaunchPadTests.FolderOverlayViewPagingTests/testPageCount_multiplePages_showsDots` | `LaunchPadTests.FolderOverlayViewPagingTests/pageCount_multiplePages_showsDots()` | 1 个原断言逐项迁移 | `@MainActor` suite | 独立 `makePagingOverlay()` | 无共享状态 |
